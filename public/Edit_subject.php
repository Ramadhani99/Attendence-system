...
if($result&& mysqli_affected_rows($connection)==1){
  //success
$_SESSION["massage"]  ="subject Updated";
  redirect_to("manage_content.php");
}
else{
...
<div class="container-fluid">
     ...
     echo massage(); 
       ...
       ?>
         ...
         <form class="form-horizontal" action="Edit_subject.php?subject=<?php echo $current_subject["id"];?> " method="post">
<fieldset>

<!-- Form Name -->
<legend>Edit_Subject <?php echo $current_subject["menu_name"]; ?></legend>
